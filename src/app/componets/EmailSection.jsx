    ...
    <section className="grid md:grid-cols-2 my-12 md:my-12 py-24 gap-4 relative">
      ...
      <div className="z-10">
        ...
        <p className="text-[#ADB7BE] mb-4 max-w-md">
          {" "}
          I&apos;m always looking for new opportunities and would love to make
      ...
      <div>
        {emailSubmitted ? (
          ...
          <form className="flex flex-col" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="bg-primary-500 hover:bg-primary-600 text-white font-medium py-2.5 px-2.5 rounded-lg w-full "
            >
              Send Message
            </button>
          </form>
